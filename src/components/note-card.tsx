    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden">
          <Dialog.Close className="absolute right-0 top-0 bg-slate-800 p-1.5 text-slate-400 rounded-full md:rounded-md hover:text-slate-100">
            <X className="size-5" />
          </Dialog.Close>
          ...
          <button
            ...
            className="w-full bg-slate-800 py-4 text-center text-sm text-slate-100 outline-none font-medium group"
          >
            Deseja{' '}
